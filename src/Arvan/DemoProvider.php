...
final class DemoProvider implements ProviderInterface
{
    ...
    public function plans(string $product): array
    {
        $catalog = [
            'cloud_server' => [
                ['g1-1-1-25',  'پایه',      ['CPU' => '۱ هسته', 'RAM' => '۱ گیگابایت', 'دیسک' => '۲۵ گیگ SSD', 'ترافیک' => 'نامحدود داخلی']],
                ['g1-2-2-25',  'اقتصادی',   ['CPU' => '۲ هسته', 'RAM' => '۲ گیگابایت', 'دیسک' => '۲۵ گیگ SSD', 'ترافیک' => 'نامحدود داخلی']],
                ['g1-4-4-50',  'حرفه‌ای',    ['CPU' => '۴ هسته', 'RAM' => '۴ گیگابایت', 'دیسک' => '۵۰ گیگ SSD', 'ترافیک' => 'نامحدود داخلی']],
                ['g1-8-8-100', 'سازمانی',   ['CPU' => '۸ هسته', 'RAM' => '۸ گیگابایت', 'دیسک' => '۱۰۰ گیگ SSD', 'ترافیک' => 'نامحدود داخلی']],
            ],
            'cdn' => [
                ['cdn-basic',  'پایه',          ['ترافیک' => '۵۰ گیگ در ماه', 'گواهی SSL' => 'رایگان', 'DDoS' => 'محافظت پایه']],
                ['cdn-growth', 'رشد',        ['ترافیک' => '۵۰۰ گیگ در ماه', 'گواهی SSL' => 'رایگان', 'DDoS' => 'محافظت پیشرفته', 'WAF' => 'دارد']],
                ['cdn-pro',    'حرفه‌ای',           ['ترافیک' => '۳ ترابایت در ماه', 'گواهی SSL' => 'رایگان', 'DDoS' => 'محافظت کامل', 'WAF' => 'دارد', 'پشتیبانی' => 'اختصاصی']],
            ],
            'object_storage' => [
